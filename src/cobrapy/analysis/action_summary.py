...
"""
    ...
    results_template: list = [
        {
            "start_timestamp": "4.97s",
            "sentiment": "Positive, Negative, or Neutral",
            "end_timestamp": "16s",
            "scene_theme": "Dramatic",
            "characters": "Man in hat, woman in jacket. For Basketball, put the name of all players in each scene",
            ...
            "key_objects": "Any objects in the timerange, include colors along with descriptions. all people should be in this, with as much detail as possible extracted from the frame (clothing,colors,age). Be incredibly detailed",
        },
        {
            "start_timestamp": "16s",
            "sentiment": "Positive, Negative, or Neutral",
            "end_timestamp": "120s",
            "scene_theme": "Emotional, Heartfelt",
            "characters": "Man in hat, woman in jacket, put the name of all players in each scene",
